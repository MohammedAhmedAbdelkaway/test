...
$module_name = "top_fcA_$ARGV[7]"; #ARGV[7] is the fc number
...
///////////architecture parameters//////
    ...
    ADDRESS_BITS                    = $ARGV[5],
    ARITH_TYPE                      = $ARGV[6],
    ADDRESS_SIZE_IFM                = $clog2(IFM_WIDTH*IFM_HEIGHT), // Not Needed
...
chdir "./CU_DP";
system("perl FC1_CU_gen.pl $ARGV[0]  $ARGV[3] $ARGV[7] $ARGV[8] $ARGV[9]");
my $unit_name = "FCA${\($ARGV[7])}_CU";
print $fh <<"DONATE";
...
system("perl FC1_DP_gen.pl $ARGV[6]  $ARGV[0] $ARGV[5] $ARGV[3] $ARGV[4] $ARGV[7] $ARGV[9]");
$unit_name = "FCA${\($ARGV[7])}_DP";
