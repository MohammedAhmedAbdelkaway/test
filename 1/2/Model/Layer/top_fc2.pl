...
#ARGV[1] IFM_WIDTH 28
#ARGV[2] IFM_HEIGHT 28
#ARGV[3] IFM_DEPTH 84
#ARGV[4] NUMBER_OF_WM 10
#ARGV[5] ADDRESS_BITS 16
#ARGV[6] ARITH_TYPE = 1
#ARGV[7] FC_number 1
#ARGV[8] Is it the last FC? (1 Yes/0 No) 0
#ARGV[9]
#
...
$module_name = "top_fcB_$ARGV[7]"; #ARGV[7] is the fc_number
...
chdir "./CU_DP";
system("perl FC2_CU_gen.pl $ARGV[0]  $ARGV[3] $ARGV[7] $ARGV[8] $ARGV[9]"); # Change "argv[1]" to "argv[2]" to send ifm_depth ???????????????
my $unit_name = "FCB${\($ARGV[7])}_CU";
print $fh <<"DONATE";
...
system("perl FC2_DP_gen.pl $ARGV[6]  $ARGV[0] $ARGV[5] $ARGV[3] $ARGV[4] $ARGV[7] $ARGV[9]");
$unit_name = "FCB${\($ARGV[7])}_DP";
